	...
	<div class="slider-wrapper">
		...
		<div id="da-slider" class="da-slider">
			<div class="da-slide">
				...
				<div class="da-img"><img src="img/parallax-slider/vape1-index.png" style="width: 360px;"alt="image01" /></div>
			</div>
			<div class="da-slide">
				<h2>Mod & Pod</h2>
				...
				<a href="#" class="da-link">Lihat Produk</a>
				<div class="da-img"><img src="img/parallax-slider/pod.jpg" style="width: 280px;"alt="image02" /></div>
			</div>
			<div class="da-slide">
				<h2>liquid</h2>
				...
				<a href="#" class="da-link">Lihat Produk</a>
				<div class="da-img"><img src="img/parallax-slider/liquid.jpg"style="width: 280px;" alt="image03" /></div>
			</div>
			<div class="da-slide">
				<h2>Custom vape</h2>
				...
				<a href="#" class="da-link">Lihat Produk</a>
				<div class="da-img"><img src="img/parallax-slider/vape3-index.jpg" style="width: 280px;"alt="image04" /></div>
			</div>
			<nav class="da-arrows">
      		...
      		<div class="row">
        		...
        		<div class="span4">
          			<div class="icons-box">
                        ...
                        <img src="<?php echo 'gambar/' . $data['br_gbr']; ?>" style = "width : 250px;" />
